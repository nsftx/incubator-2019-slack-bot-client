...
<form id="forma">
    <div id="section">  <p>Edit User <label id="close-icon" @click="exit" style="font-size: 20px"> X </label> </p></div>
    <div id="inner-wrap">
        <label>Email </label><input type="text" name="field1" placeholder="New user email" v-model="title" id="field1"/>
        <label> Role </label> <input type="text" name="field1" placeholder="New user role" v-model="title" id="field2"/>
